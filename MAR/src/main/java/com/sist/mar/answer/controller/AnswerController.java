...
public class AnswerController {
	...
	@RequestMapping(value = "answer/get_all.do",method = RequestMethod.GET
	 ...
	 * @throws SQLException 
	 */     
	@RequestMapping(value = "answer/do_selectone.do",method = RequestMethod.GET
			,produces = "application/json;charset=UTF-8")
	@ResponseBody	
	public String doSelectOne(Answer answer) throws SQLException {
		LOG.debug("param:"+answer);
		
		Answer outVO = (Answer) answerService.doSelectOne(answer);
	 ...
	 * @throws SQLException
	 */
	@RequestMapping(value = "answer/do_delete.do", method = RequestMethod.POST
				,produces = "application/json;charset=UTF-8")
	@ResponseBody
	 ...
	 * @throws SQLException 
	 */
	@RequestMapping(value = "answer/do_insert.do", method = RequestMethod.POST
					,produces = "application/json;charset=UTF-8")
	@ResponseBody
