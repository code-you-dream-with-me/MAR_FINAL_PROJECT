			...
			success:function(data){//통신 성공
				...
				if(parseData.length>0){
					...
					$.each(parseData, function(i, value){
						...
						html+=" 				<a class='' href='#' role='button' id='dropdownMenuLink' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>";
						html+=" 				<i class='fas fa-chevron-down'></i>";
						html+=" 				</a>";
						html+=" 			<div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>";
						html+=" 				<button class='dropdown-item text-primary' onclick='doUpdate("+value.answerNo+");'>Edit</button>";
						html+=" 				<button class='dropdown-item text-primary' onclick='doDelete("+value.answerNo+");'>Delete</button>";
						html+=" 			</div>";
						html+=" 			</div>";
						html+=" 		</div>";
						html+=" 	<div class=''>";
